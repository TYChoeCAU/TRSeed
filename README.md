...
The first command generates Node2Vec embeddings for the AMiner dataset.
The second command trains and evaluates TRSeed using the generated embeddings.
