...
def parse_args():
    ...
    parser.add_argument("--dataset", nargs="?", default="aminer",
                        help="Choose a dataset:[ali, amazon, aminer, gowalla, yelp2018, ml-1m, ml-100k]")
    parser.add_argument(
    ...
    parser.add_argument("--gnn", nargs="?", default="TRSeed")
    ...
    parser.add_argument('--n2v_path', type=str, default=None, help='Path to pre-trained node2vec embeddings')
    parser.add_argument('--lamb', type=float, default=0.1, help='Weight for the node2vec embeddings in weighted sum.')
